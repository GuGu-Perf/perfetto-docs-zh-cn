...
![火焰图，选中 `java.lang.String`。其详情弹出窗口列出 Cumulative size（2.48 MiB，10.48%）、Root Type（`ROOT_INTERNED_STRING`）、Heap Type 和 Self Count（53,546）。](/docs/images/heap_docs/02-flamegraph-menu.png)
