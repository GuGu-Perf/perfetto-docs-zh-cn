...
| 英文标题 | 中文翻译 | 说明 |
|---------|---------|------|
| `### Collecting your first heap profile` | `### 收集你的第一个 heap profile` | 翻译了动词,保留技术术语 |
| `### Visualizing your first heap profile` | `### 可视化你的第一个 heap profile` | 翻译了动词,保留技术术语 |
| `### Querying your first heap profile` | `### 查询你的第一个 heap profile` | 翻译了动词,保留技术术语 |
| `### Example config` | `### 配置示例` | 完整翻译 |
| `### Recording instructions` | `### 录制说明` | 完整翻译 |
| `### Wire protocol` | `### 线路协议` | 技术术语翻译 |
| `### Fork handling` | `### Fork 处理` | 技术术语保留 |
| `### ART execution mode` | `### ART 执行模式` | 技术术语保留 |
| `### SQL 模块` | `### SQL 模块` | 已翻译,无需修改 |
| `### Proto 描述符` | `### Proto 描述符` | 已翻译,无需修改 |
...
```bash
# 查找所有未翻译的三级标题(### 开头且包含大写字母的标题)
grep -n "^### [A-Z]" docs/*.md docs/**/*.md

# 查找所有未翻译的四级标题(#### 开头且包含大写字母的标题)
grep -n "^#### [A-Z]" docs/*.md docs/**/*.md

# 查找所有未翻译的五级标题(##### 开头且包含大写字母的标题)
grep -n "^##### [A-Z]" docs/*.md docs/**/*.md
```

如果以上命令有输出,说明还有未翻译的标题,需要修复。
